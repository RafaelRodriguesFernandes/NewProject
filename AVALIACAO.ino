 ...
 * Graduando em Engenharia Naval e Oceânica pela Unversidade Feredal do Rio de Janeiro (UFRJ)
 */
//decalrar todas as variáveis que serão usadas:
...
int buttonStateA0;//referente ao botão da esquerda.
int buttonStateA1;//referente ao botão da direita.
...
void loop() {
  ...
  //leitura dos botões a cada 0,7s para evitar dupla leitura no caso de um clique mais longo:
  delay(700);
  //caso permaneça pressionado, o valor do produto será atualizado até o valor desejado
}
