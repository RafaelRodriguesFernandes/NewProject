...
void loop() {
  ...
  while (buttonStateA0 == HIGH || buttonStateA1 == HIGH){
    ...
    //compara o valor da dezena para ordenar quais LEDs serão acesos e quias serão apagados no display da esquerda:
    switch(dezena){
    ...
    //compara o valor da unidade para ordenar quais LEDs serão acesos e quias serão apagados no display da direita:
    switch(unidade){
      case 0: {
